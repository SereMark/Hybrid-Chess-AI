...
enum Piece : uint8_t { PAWN,
                       ...
                       KING,
                       PIECE_NONE };
enum Color : uint8_t { WHITE,
                       BLACK,
                       COLOR_NONE };
enum Result : uint8_t { ONGOING,
                        WHITE_WIN,
                        BLACK_WIN,
                        DRAW };
...
constexpr Square A1 = 0, B1 = 1, C1 = 2, D1 = 3, E1 = 4, F1 = 5, G1 = 6, H1 = 7, A8 = 56, B8 = 57,
                 C8 = 58, D8 = 59, E8 = 60, F8 = 61, G8 = 62, H8 = 63;
...
constexpr Bitboard WHITE_KINGSIDE_CLEAR = 0x60ULL, WHITE_QUEENSIDE_CLEAR = 0xEULL,
                   ...
                   BLACK_QUEENSIDE_CLEAR = 0xE00000000000000ULL;
...
class alignas(64) Position {
  ...
  private:
    ...
    void parse_game_state_from_fen(const std::string &, const std::string &, const std::string &,
                                   uint16_t, uint16_t);
