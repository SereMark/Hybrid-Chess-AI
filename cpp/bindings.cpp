...
PYBIND11_MODULE(chessai, m) {
  ...
  py::class_<chess::Move>(m, "Move")
      ...
      .def(py::init<int, int, chess::Piece>(), "Create promotion move", py::arg("from_sq"),
  ...
  py::class_<chess::Position>(m, "Position")
      ...
      .def_property_readonly("castling", &chess::Position::get_castling, "Castling rights")
      .def_property_readonly("ep_square", &chess::Position::get_ep_square, "En passant square")
      .def_property_readonly("halfmove", &chess::Position::get_halfmove, "Halfmove clock")
      .def_property_readonly("fullmove", &chess::Position::get_fullmove, "Fullmove number")
      .def_property_readonly("hash", &chess::Position::get_hash, "Zobrist hash");

  py::class_<mcts::MCTS>(m, "MCTS")
      .def(py::init<int, float, float, float>(), py::arg("simulations") = 800,
           py::arg("c_puct") = 1.0f, py::arg("dirichlet_alpha") = 0.3f, py::arg("dirichlet_weight") = 0.25f,
           "Create MCTS engine with simulation count, exploration constant, and Dirichlet parameters")
      .def("search", &mcts::MCTS::search, "Run MCTS search and return visit counts", py::arg("position"),
           py::arg("policy"), py::arg("value"))
      .def("search",
           [](mcts::MCTS &engine, const chess::Position &pos,
              const py::array_t<float, py::array::c_style | py::array::forcecast> &policy, float value) {
           ...
           "Run MCTS search with numpy policy and return visit counts", py::arg("position"), py::arg("policy"),
           py::arg("value"))
      ...
      .def("set_dirichlet_params", &mcts::MCTS::set_dirichlet_params, "Set Dirichlet parameters",
           py::arg("alpha"), py::arg("weight"));

  m.def("encode_move_index", &mcts::encode_move_index, "Encode a move into the 73x64 policy index");
