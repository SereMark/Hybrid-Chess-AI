...
SELFPLAY = _NS(
    ...
    LOOP_MIN_PLIES=64,
    LOOP_UNIQUE_RATIO_MAX=0.52,
    LOOP_PENALTY_VALUE=0.0,
    LOOP_AUTO_RESET_THRESHOLD=55.0,
    LOOP_AUTO_RESET_COOLDOWN=12,
)
...
SAMPLING = _NS(
    ...
    TRAIN_RECENT_SAMPLE_RATIO=0.65,
    TRAIN_RECENT_SAMPLE_RATIO_MIN=0.40,
...
MCTS = _NS(
    TRAIN_SIMULATIONS_BASE=128,
    TRAIN_SIMULATIONS_MIN=48,
...
RESIGN = _NS(
    ...
    VALUE_THRESHOLD_RAMP_START=24,
    VALUE_THRESHOLD_RAMP_END=144,
    MIN_PLIES_INIT=60,
    MIN_PLIES_FINAL=24,
    MIN_PLIES_RAMP_END=144,
    CONSECUTIVE_PLIES=3,
    CONSECUTIVE_MIN=2,
...
SAMPLING.LOOP_DUPLICATE_WEIGHT = 1
