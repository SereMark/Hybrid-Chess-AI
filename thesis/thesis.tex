...
\item \textbf{Tanulás:} belső metrikák jelentős csökkenése (a policy-veszteség legalább 40\% körüli, az érték-veszteség pedig nagyjából 50\% körüli relatív javulása).
...
A fejlesztés három fő pillére az architekturális egyszerűsítés („Mindig világos” kanonikus nézet), a virtuális veszteségre épülő konkurenciakezelés és a kötegelt levélértékelés volt. Ez a kanonikus nézet ésszerű mérnöki kompromisszumként értelmezhető: jelen munka kvalitatívan vizsgálja a hatását, de nem választja el teljesen a többi architekturális döntés hatásától. Ezek együtt biztosítják a szükséges sebességet a korlátos erőforrású környezetben. Az öt konfigurációt lefedő kísérleti validáció megmutatta, hogy a magas entrópiájú keresés hozza a legjobb eredményt a rendelkezésre álló adat- és időkeret mellett.
