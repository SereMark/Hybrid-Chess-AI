...
constexpr Square A1 = 0, B1 = 1, C1 = 2, D1 = 3, E1 = 4, F1 = 5, G1 = 6, H1 = 7, A8 = 56, B8 = 57, C8 = 58, D8 = 59,
                 E8 = 60, F8 = 61, G8 = 62, H8 = 63;

constexpr Square WHITE_KING_START = E1, WHITE_KING_KINGSIDE = G1, WHITE_KING_QUEENSIDE = C1,
                 WHITE_ROOK_KINGSIDE_START = H1, WHITE_ROOK_KINGSIDE_END = F1, WHITE_ROOK_QUEENSIDE_START = A1,
                 WHITE_ROOK_QUEENSIDE_END = D1;

constexpr Square BLACK_KING_START = E8, BLACK_KING_KINGSIDE = G8, BLACK_KING_QUEENSIDE = C8,
                 BLACK_ROOK_KINGSIDE_START = H8, BLACK_ROOK_KINGSIDE_END = F8, BLACK_ROOK_QUEENSIDE_START = A8,
...
struct MoveList {
  ...
  [[nodiscard]] [[gnu::always_inline]] size_t size() const noexcept { return count; }
  [[nodiscard]] [[gnu::always_inline]] bool empty() const noexcept { return count == 0; }
  [[gnu::always_inline]] Move& operator[](size_t i) noexcept { return moves[i]; }
  [[gnu::always_inline]] const Move& operator[](size_t i) const noexcept { return moves[i]; }
  ...
  [[gnu::always_inline]] const Move* end() const noexcept { return moves + count; }
};
...
[[gnu::always_inline, gnu::const]] inline Square lsb(Bitboard b) noexcept { return __builtin_ctzll(b); }
[[gnu::always_inline, gnu::const]] inline int popcount(Bitboard b) noexcept { return __builtin_popcountll(b); }
