...
EVAL_BATCH_SIZE_MAX = 32768
EVAL_BATCH_COALESCE_MS = 14
EVAL_CACHE_CAPACITY = 180_000
EVAL_WORKER_JOIN_TIMEOUT_S = 0.15
EVAL_CACHE_USE_FP16 = True

## Self-play / replay buffer
REPLAY_BUFFER_CAPACITY = 220_000
SELFPLAY_NUM_WORKERS = 24
GAME_MAX_PLIES = 400
SELFPLAY_TEMP_MOVES = 45
SELFPLAY_TEMP_HIGH = 0.90
SELFPLAY_TEMP_LOW = 0.07
SELFPLAY_DETERMINISTIC_TEMP_EPS = 0.005
SELFPLAY_OPENING_RANDOM_PLIES_MAX = 10

## MCTS settings (training)
MCTS_TRAIN_SIMULATIONS_BASE = 640
MCTS_TRAIN_SIMULATIONS_MIN = 128
MCTS_TRAIN_SIM_DECAY_MOVE_INTERVAL = 16
MCTS_C_PUCT = 1.35
...
## Schedule / iteration
TRAIN_TOTAL_ITERATIONS = 120
SELFPLAY_GAMES_PER_ITER = 480
TRAIN_LR_SCHED_STEPS_PER_ITER_EST = 40
