...
EVAL_MAX_BATCH = 4096
EVAL_BATCH_TIMEOUT_MS = 6
EVAL_CACHE_SIZE = 40_000
...
POLICY_LABEL_SMOOTH = 0.06
ENTROPY_COEF_INIT = 2.0e-4
ENTROPY_ANNEAL_ITERS = 80
ENTROPY_COEF_MIN = 5.0e-05
EMA_ENABLED = True
EMA_DECAY = 0.999
