...
LOG_LEVEL = "INFO"
CUDA_EMPTY_CACHE_EVERY_ITERS = 10
OPENINGS_FILE_PATH = "openings.txt"
CHECKPOINT_SAVE_EVERY_ITERS = 5
...
EVAL_BATCH_SIZE_MAX = 4096
EVAL_BATCH_COALESCE_MS = 3
EVAL_CACHE_CAPACITY = 100_000
EVAL_WORKER_JOIN_TIMEOUT_S = 0.25
EVAL_CACHE_USE_FP16 = True

REPLAY_BUFFER_CAPACITY = 150_000
SELFPLAY_NUM_WORKERS = 8
GAME_MAX_PLIES = 512
...
ARENA_EVAL_EVERY_ITERS = 15
ARENA_EVAL_CACHE_CAPACITY = 32_768
ARENA_GAMES_PER_EVAL = 1200
