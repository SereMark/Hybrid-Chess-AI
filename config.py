...
EVAL = _NS(
    ...
    BATCH_SIZE_MAX=1024,
    CACHE_USE_FP16=True,
    CACHE_CAPACITY=16_000,
    ARENA_CACHE_CAPACITY=12_000,
)
...
MCTS = _NS(
    ...
    TRAIN_SIM_DECAY_MOVE_INTERVAL=18,
    C_PUCT=1.35,
    C_PUCT_BASE=19652.0,
    C_PUCT_INIT=1.55,
...
TRAIN = _NS(
    ...
    LR_WARMUP_STEPS=500,
    LR_FINAL=5.0e-4,
    LR_SCHED_STEPS_PER_ITER_EST=96,
...
ARENA = _NS(
    ...
    GATE_MIN_DECISIVES=80,
    CANDIDATE_MAX_ROUNDS=4,
    CANDIDATE_MAX_GAMES=240,
    PAIRING_FACTOR=2,
    GATE_EPS=1e-9,
)
