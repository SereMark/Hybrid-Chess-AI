...
from src.utils.chess_utils import convert_board_to_input,get_move_mapping,flip_board,flip_move,mirror_rank,mirror_move_rank
                        ...
                        while self.total_games_processed<self.max_games:
                            ...
                            while node.variations:
                                ...
                                if self.augment_mirror_rank:
                                    rb=mirror_rank(board)
                                    rm=mirror_move_rank(move)
