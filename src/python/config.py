...
SELFPLAY = _NS(
    ...
    ADJUDICATE_MIN_PLIES=140,
    ADJUDICATE_MARGIN_START=6.5,
    ADJUDICATE_MARGIN_END=3.0,
    ADJUDICATE_MARGIN_DECAY_ITER=640,
    ADJUDICATE_MIN_PLIES_START=160,
    ADJUDICATE_MIN_PLIES_END=120,
    ADJUDICATE_MIN_PLIES_DECAY_ITER=640,
    ADJUDICATE_VALUE_MARGIN_START=0.42,
    ADJUDICATE_VALUE_MARGIN_END=0.28,
    ...
    REPETITION_AVOID_TOP_K=2,
    REPETITION_AVOID_SCALE=0.35,
    REPETITION_TEMP_BOOST=1.70,
    LOOP_MIN_PLIES=96,
    LOOP_UNIQUE_RATIO_MAX=0.65,
    LOOP_PENALTY_VALUE=0.08,
    LOOP_AUTO_RESET_THRESHOLD=28.0,
    LOOP_AUTO_RESET_COOLDOWN=6,
)
...
RESIGN = _NS(
    ...
    VALUE_THRESHOLD_INIT=-0.09,
    VALUE_THRESHOLD_RAMP_START=20,
    VALUE_THRESHOLD_RAMP_END=120,
    MIN_PLIES_INIT=56,
    MIN_PLIES_FINAL=28,
    MIN_PLIES_RAMP_END=128,
    CONSECUTIVE_PLIES=3,
    CONSECUTIVE_MIN=2,
