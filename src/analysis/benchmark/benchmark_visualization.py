...
class BenchmarkVisualization(BaseVisualizationWidget):
    ...
    def init_visualization(self):
        ...
        self.plots['benchmark_results'] = BasePlot(self.ax_benchmark, title='Benchmark Results', xlabel='Category', ylabel='Number of Games')
    ...
    def _update_bar_chart(self):
        ...
        for i, value in enumerate(values):
            self.ax_benchmark.text(i, value + 0.1, f"{value}", ha='center', fontsize=9, fontweight='bold', color='#333333')
