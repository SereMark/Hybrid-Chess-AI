from PyQt5.QtWidgets import QVBoxLayout, QGroupBox, QGridLayout, QLineEdit, QPushButton, QHBoxLayout, QMessageBox, QCheckBox, QLabel, QComboBox, QFrame
...
class ReinforcementTab(BaseTab):
    ...
    def init_ui(self):
        ...
        control_buttons_layout = self.create_control_buttons("Start Self-Play","Stop Self-Play",self.start_self_play,self.stop_self_play,pause_text="Pause Training",resume_text="Resume Training",pause_callback=self.pause_worker,resume_callback=self.resume_worker)
        ...
        interval_widgets = {'iteration': self.iteration_interval_widget, 'epoch': self.epoch_interval_widget, 'time': self.time_interval_widget, 'batch': self.batch_interval_widget}
    ...
    def start_self_play(self):
        ...
        started = self.start_worker(ReinforcementWorker,
